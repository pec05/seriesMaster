...
<html>
<head>
  <title>Reality series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <div class="genre-main">
      <div class="genre-section">
        <h3 class="genre-title">
          All series of reality
        </h3>
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('reality','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('reality','notconnected','undefined');">
        <?php endif; ?>
