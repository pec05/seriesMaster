...
<html>
<head>
  <title>Kids series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <div class="genre-main">
      <div class="genre-section">
        <h3 class="genre-title">
          All the series for kids
        </h3>
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('kids','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('kids','notconnected','undefined');">
        <?php endif; ?>
