...
<html>
<head>
  <title>Documentary Series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <div class="genre-main">
      <div class="genre-section">
        <h3 class="genre-title">
          All documentary series
        </h3>
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('documentary','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('documentary','notconnected','undefined');">
        <?php endif; ?>
