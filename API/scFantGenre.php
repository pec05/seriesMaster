...
<html>
<head>
  <title>Science fiction & fantasy series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <div class="genre-main">
      <div class="genre-section">
        <h3 class="genre-title">
          All science fiction and fantasy series
        </h3>
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('fantasy','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('fantasy','notconnected','undefined');">
        <?php endif; ?>
