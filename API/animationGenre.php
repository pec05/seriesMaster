...
<html>
<head>
  <title>Animation Series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
...
<div class="genre-main">
  <div class="genre-section">
    ...
    <?php if(isset($_SESSION['login_email'])): ?>
    <body onload="sortTv('animation','connected', '<?php echo $_SESSION['sessionID']?>');">
    <?php else: ?>
    <body onload="sortTv('animation','notconnected','undefined');">
    <?php endif; ?>
