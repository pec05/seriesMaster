...
<html>
<head>
  <title>Les Mieux Notés &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <script type="text/javascript" src="../js/topRated.js"></script>
...
<div class ="main_search">
    ...
    <div class = "main-most">
      <div class ="most-popular-section">
        <h3 class="main-most-title">
          Best Rated Series 
        </h3>
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="tvTopRated('connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="tvTopRated('notconnected','undefined');">
        <?php endif; ?>
            <div 
