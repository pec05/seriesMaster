...
<html>
<head>
  <title>Crime Series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
...
<div class ="main_search">
    ...
    <div class="genre-main">
      <div class="genre-section">
        ...
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('crime','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('crime','notconnected','undefined');">
        <?php endif; ?>
