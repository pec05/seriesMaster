...
<html>
<head>
  <title>Action & Adventure Series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <div class="genre-main">
      <div class="genre-section">
        <h3 class="genre-title">
          All series of action and adventure
        </h3>
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('action','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('action','notconnected','undefined');">
        <?php endif; ?>
