...
<html>
<head>
  <title>Comedy Series &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
...
<div class ="main_search">
    ...
    <div class="genre-main">
      <div class="genre-section">
        ...
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="sortTv('comedy','connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="sortTv('comedy','notconnected','undefined');">
        <?php endif; ?>
