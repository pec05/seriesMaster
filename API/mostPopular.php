...
<html>
<head>
  <title>Most Popular &bull; SeriesMaster</title>
  <meta charset="utf-8"> 
    ...
    <script type="text/javascript" src="../js/mostPopular.js"></script>
...
<div class ="main_search">
    ...
    <div class = "main-most">
      <div class ="most-popular-section">
        ...
        <?php if(isset($_SESSION['login_email'])): ?>
        <body onload="tvPopular('connected','<?php echo $_SESSION['sessionID']?>');">
        <?php else: ?>
        <body onload="tvPopular('notconnected','undefined');">
        <?php endif; ?>
            <div 
