...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.fr/"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://www.hostinger.fr/tutoriels/"><i aria-hidden="true" class="fa fa-graduation-cap"></i> Tutoriels</a>
                </li>
                <li>
                    <a href="https://www.hostinger.fr/make-money-online/"><i aria-hidden="true" class="fa fa-trophy"></i> Gagnez de l'argent</a>
                </li>
                <li>
                    <a href="https://www.hostinger.fr/affilie/login"><i aria-hidden="true" class="fa fa-user"></i> Affiliés</a>
                </li>
                <li>
                    <a href="https://cpanel.hostinger.fr"><i aria-hidden="true" class="fa fa-lock"></i> Connexion</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.fr/gagner-argent">En savoir plus</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.fr/base-connaissances">En savoir plus</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com/blog/">En savoir plus</a>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://cpanel.hostinger.fr">Client Connexion</a>
                </div>
                <div class="copyright text-center">
                    Hostinger © 2017. Tous droits réservés
                </div>
            </div>
        </div>
    </div>
